...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <br>
      <form method="post" action="ver_mas2.php">
        <div class="btn-group" role="group" aria-label="">
          <button type="submit" name="accion" value="arrendar" class="btn btn-success">Arrendar</button>
          <button type="submit" name="accion" value="agregarw" class="btn btn-warning">Agregar a wishlist</button>
          <button type="submit" name="accion" value="agregarf" class="btn btn-info">Agregar a favoritos</button>
          <button type="submit" name="accion" value="devolver" class="btn btn-info">Devolver</button>
        </div>
      </form>
    </div>
  </div>
